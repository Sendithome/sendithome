...
export default function ShipmentsTab({ verifications, retailer }) {
  ...
  const generateAccountingPDF = async () => {
    ...
    const lines = [
      `SENDITHOME — RETAILER COMMISSION REPORT`,
      ...
      ``,
      `─────────────────────────────────────────`,
      `This document is generated by the SENDITHOME Retailer Portal.`,
    ...
    try {
      ...
      doc.text('SENDITHOME Retailer Portal  |  support@sendithomedxb.com  |  sendithomedxb.com', margin, 291);
