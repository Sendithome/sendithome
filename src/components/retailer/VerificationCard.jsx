          ...
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
            ...
            <div className="bg-[#0B1120] rounded-xl p-4 text-xs text-slate-300 space-y-2 leading-relaxed mb-4">
              ...
              <ol className="list-decimal pl-4 space-y-1">
                ...
                <li>You approve the export of these goods through the <BrandName /> certified channel.</li>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 italic">Queries pause the 24-hour timer and escalate to <BrandName /> compliance team.</p>
            </div>
