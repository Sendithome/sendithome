...
const COUNTRIES_LANGUAGES = [
  { country: 'United Arab Emirates', flag: '🇦🇪', lang: 'ar', langName: 'Arabic', code: 'AE' },
  ...
  { country: 'Lebanon', flag: '🇱🇧', lang: 'ar', langName: 'Arabic', code: 'LB' },
  ...
  { country: 'Nigeria', flag: '🇳🇬', lang: 'en', langName: 'English', code: 'NG' },
  { country: 'India', flag: '🇮🇳', lang: 'hi', langName: 'Hindi', code: 'IN' },
  { country: 'Pakistan', flag: '🇵🇰', lang: 'ur', langName: 'Urdu', code: 'PK' },
  { country: 'Bangladesh', flag: '🇧🇩', lang: 'bn', langName: 'Bengali', code: 'BD' },
  ...
  { country: 'Sri Lanka', flag: '🇱🇰', lang: 'si', langName: 'Sinhala', code: 'LK' },
  { country: 'Nepal', flag: '🇳🇵', lang: 'ne', langName: 'Nepali', code: 'NP' },
  ...
  { country: 'Russia', flag: '🇷🇺', lang: 'ru', langName: 'Russian', code: 'RU' },
  ...
  { country: 'Brazil', flag: '🇧🇷', lang: 'pt', langName: 'Portuguese', code: 'BR' },
  { country: 'Mexico', flag: '🇲🇽', lang: 'es', langName: 'Spanish', code: 'MX' },
  { country: 'Argentina', flag: '🇦🇷', lang: 'es', langName: 'Spanish', code: 'AR' },
  { country: 'South Africa', flag: '🇿🇦', lang: 'en', langName: 'English', code: 'ZA' },
  { country: 'Kenya', flag: '🇰🇪', lang: 'sw', langName: 'Swahili', code: 'KE' },
  { country: 'Ethiopia', flag: '🇪🇹', lang: 'am', langName: 'Amharic', code: 'ET' },
  { country: 'Ghana', flag: '🇬🇭', lang: 'en', langName: 'English', code: 'GH' },
  { country: 'Israel', flag: '🇮🇱', lang: 'iw', langName: 'Hebrew', code: 'IL' },
  { country: 'Iran', flag: '🇮🇷', lang: 'fa', langName: 'Persian', code: 'IR' },
];
