      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {repOrders.length > 0 && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
            className="bg-amber-500/10 border border-amber-500/30 rounded-2xl px-5 py-4 space-y-3">
            <div className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              {repOrders.map(order => (
                <div key={order.id} className="bg-card/80 border border-border rounded-xl px-3 py-2.5 flex items-center gap-3 flex-wrap">
