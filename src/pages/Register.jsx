          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex items-start gap-2.5 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5">
              ...
              <p className="text-[11px] text-blue-700 leading-relaxed">
                Passport details are required for <strong>international shipping and customs clearance</strong> only. Your information is stored securely on <strong>Microsoft Azure</strong> infrastructure and protected in accordance with international data privacy regulations.
              </p>
            </div>
