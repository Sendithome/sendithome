...
const SHOWCASE_PAGES = [
  {
    ...
    pages: [
      ...
      { label: 'Receipt Upload', path: '/order/demo/receipts' },
      { label: 'Payment', path: '/order/demo/payment' },
      { label: 'My Orders', path: '/my-orders' },
      { label: 'Order Detail', path: '/order/demo' },
      { label: 'Track Shipment', path: '/track' },
      { label: 'Profile', path: '/profile' },
      { label: 'Tourist Portal (Shipment View)', path: '/shipment/demo' },
