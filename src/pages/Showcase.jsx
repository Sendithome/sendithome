...
const SHOWCASE_PAGES = [
  {
    ...
    pages: [
      // Primary Flow
      { label: '① QR Landing (Guest Onboarding)', path: '/guest-onboarding/69c10e96d7e89842ae433412', sequence: true },
      { label: '② Register / Create Account', path: '/register', sequence: true },
      { label: '③ New Shipment', path: '/new-order', sequence: true },
      { label: '④ Receipt Upload', path: '/order/6a3ba85284af787d7be0cca3/receipts', sequence: true },
      { label: '⑤ Payment', path: '/order/6a2fbf7d5f12048618aab1dd/payment', sequence: true },
      { label: '⑥ Shipment Details', path: '/order/6a3ba85284af787d7be0cca3', sequence: true },
      // Supporting Pages
  ...
  },
  {
    ...
    pages: [
      ...
      { label: 'Premium & Luxury Retailer Intelligence Platform', path: 'https://claude.ai/public/artifacts/f354bdaa-64e6-464d-8169-16bc6aae4a1b', external: true },
