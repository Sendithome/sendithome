...
function getInventoryTier(rooms) {
  ...
  if (r <= 299) return { tier: 1, allocated: 20, reorderAt: 10, replenishQty: 10 };
  if (r <= 399) return { tier: 2, allocated: 30, reorderAt: 20, replenishQty: 10 };
  if (r <= 499) return { tier: 3, allocated: 40, reorderAt: 30, replenishQty: 10 };
  if (r <= 799) return { tier: 4, allocated: 50, reorderAt: 40, replenishQty: 10 };
